...
#=> WindowsPath('C:/Users/patri/Dropbox/Ph.D/OrganoNet/Websites/postgresql_aws2/updated_iotd/iotd')
...
SECRET_KEY = "django-insecure-w(297u3umjv+ct!@_+k5j8y+$4r^=+0ce!8uj&k@ua9lxh5kez"
...
TEMPLATES = [
    {
        ...
        "DIRS": [os.path.join(BASE_DIR, 'iotd/templates')],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
